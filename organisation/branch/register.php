...
require 'server/connect.php';
    $getOrgnizations = mysqli_query($conn,"SELECT * FROM organization") or die(mysqli_error($conn)); 
    $organizationArray = array();
                
	while($singleOrg = mysqli_fetch_array($getOrgnizations))
    $organizationArray[] = $singleOrg; 
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form  action="server/register.php" method="POST" class="pt-3">
                ...
                <div class="form-group">
                  <input name="branchName" type="text" required class="form-control form-control-lg" id="exampleInputUsername1" placeholder="Branch Name *">
                </div>
                ...
                <div class="form-group">
                  <select name="organisationName" required class="form-control form-control-lg" id="exampleFormControlSelect2">
                    
                    <option>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Organisation Name *</option>
                    <?php  foreach($organizationArray as $singleOrg){ ?>
                    <option value="<?php echo $singleOrg['id'] ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $singleOrg['organisationName'] ?></option>
                    <?php } ?>
                    ...
                    <div id="addressBlock">
                      ...
                      Your Address to collect waste from
                    </p>
